...
jest.mock('../backend/services/safeService', () => ({
  ...
  discoverAllowanceRevocations: jest.fn(async (address, payload) => ({ address, payload, approvals: [], unsupported: [] })),
  ...
  proposeAllowanceRevocations: jest.fn(async (address, payload) => ({ address, payload, approvals: [], unsupported: [], batches: [] })),
